...
# Từ điển đa ngôn ngữ đầy đủ (16 Ngôn ngữ)
TRANSLATIONS = {
    "English": {
        "title": "RPYtoEXCEL",
        ...
        "tab_sync": " 3. Sync Old RPY -> New RPY ",
        ...
        "sync_frame": " Sync Translations (Old RPY -> New RPY) ",
        "lbl_old_rpy_step": (
            "1. Select or DROP OLD translated .rpy file(s) / folder:"
        ),
        "lbl_new_rpy_step": (
            "2. Select or DROP NEW untranslated .rpy file(s) / folder:"
        ),
        "btn_start_sync": " START SYNCING TRANSLATIONS ",
        "excel_notes_sheet": (
            "Please provide translations in the 'Translated' column. Once"
            " finished, save the file and use the 'Merge Excel -> RPY' tab to"
        ...
        "msg_warn_rpy_folder": (
            "Please select at least one .rpy file or directory!"
        ),
        "msg_success_merge": (
            "Successfully merged translations into {} .rpy file(s)!"
        ),
        "msg_err_merge": "An error occurred while merging:\n{}",
        "msg_warn_sync_old": (
            "Please select at least one OLD translated .rpy file!"
        ),
        "msg_warn_sync_new": "Please select at least one NEW .rpy file!",
        "msg_success_sync": (
            "Successfully synced translations!\n- Files updated: {}\n- Dialogue"
            " matched: {}"
        ),
        "msg_err_sync": "An error occurred while syncing:\n{}",
    ...
    "Tiếng Việt": {
        ...
        "tab_sync": " 3. Đồng bộ RPY Cũ -> RPY Mới ",
        ...
        "lbl_excel_step": (
            "1. Chọn hoặc KÉO THẢ file Excel đã dịch vào ô bên dưới:"
        ),
        ...
        "sync_frame": " Đồng bộ bản dịch từ RPY Cũ sang RPY Mới ",
        "lbl_old_rpy_step": (
            "1. Chọn/KÉO THẢ các file/thư mục .rpy CŨ (Đã dịch):"
        ),
        "lbl_new_rpy_step": (
            "2. Chọn/KÉO THẢ các file/thư mục .rpy MỚI (Chưa dịch):"
        ),
        "btn_start_sync": " BẮT ĐẦU ĐỒNG BỘ BẢN DỊCH ",
        "excel_notes_sheet": (
            "Vui lòng dịch ở cột 'Bản dịch'. Sau khi hoàn tất, lưu file và sử"
            " dụng tab 'Ghép Excel -> RPY' để hợp nhất bản dịch vào game."
        ),
        ...
        "msg_warn_rpy_folder": (
            "Vui lòng chọn ít nhất 1 file hoặc thư mục chứa .rpy!"
        ),
        "msg_success_merge": (
            "Đã hợp nhất thành công bản dịch vào {} file .rpy!"
        ),
        "msg_err_merge": "Có lỗi xảy ra khi merge:\n{}",
        "msg_warn_sync_old": "Vui lòng chọn ít nhất 1 file RPY CŨ đã dịch!",
        "msg_warn_sync_new": (
            "Vui lòng chọn ít nhất 1 file RPY MỚI cần cập nhật!"
        ),
        "msg_success_sync": (
            "Đã đồng bộ bản dịch thành công!\n- Số file được cập nhật: {}\n- Số"
            " câu thoại khớp: {}"
        ),
        "msg_err_sync": "Có lỗi xảy ra khi đồng bộ:\n{}",
    ...
    "Español": {
        ...
        "sync_frame": " Sincronizar RPY Antiguo -> RPY Nuevo ",
        "lbl_old_rpy_step": "1. Seleccione archivos .rpy ANTIGUOS traducidos:",
        "lbl_new_rpy_step": "2. Seleccione archivos .rpy NUEVOS no traducidos:",
        "btn_start_sync": " INICIAR SINCRONIZACIÓN ",
        "excel_notes_sheet": (
            "Traduzca en la columna 'Traducción'. Guarde el archivo y use la"
            " pestaña 'Combinar Excel -> RPY'."
        ),
        ...
        "msg_warn_rpy_folder": (
            "¡Seleccione al menos un archivo .rpy o carpeta!"
        ),
        "msg_success_merge": (
            "¡Traducciones combinadas con éxito en {} archivo(s)!"
        ),
        "msg_err_merge": "Error al combinar:\n{}",
        "msg_warn_sync_old": "¡Seleccione al menos un archivo RPY antiguo!",
        "msg_warn_sync_new": "¡Seleccione al menos un archivo RPY nuevo!",
        "msg_success_sync": (
            "¡Sincronización exitosa!\n- Archivos actualizados: {}\n- Frases"
            " coincidentes: {}"
        ),
        "msg_err_sync": "Error al sincronizar:\n{}",
    ...
    "中文": {
        ...
        "sync_frame": " 同步旧版 RPY 翻译至新版 RPY ",
        "lbl_old_rpy_step": "1. 选择或拖放已翻译的【旧版 .rpy】文件/文件夹：",
        "lbl_new_rpy_step": "2. 选择或拖放未翻译的【新版 .rpy】文件/文件夹：",
        "btn_start_sync": " 开始同步翻译 ",
        "excel_notes_sheet": (
            "请在 '译文' 列中提供翻译。完成后保存并使用 '合并 Excel -> RPY'"
            " 选项卡。"
        ),
        ...
        "msg_err_merge": "合并时出错：\n{}",
        "msg_warn_sync_old": "请至少选择一个已翻译的旧版 .rpy 文件！",
        "msg_warn_sync_new": "请至少选择一个未翻译的新版 .rpy 文件！",
        "msg_success_sync": (
            "成功同步翻译！\n- 已更新文件数：{}\n- 成功匹配对话数：{}"
        ),
        "msg_err_sync": "同步时出错：\n{}",
    ...
    "Deutsch": {
        ...
        "tab_sync": " 3. RPY Synchronisieren ",
        "export_frame": " Übersetzungsdateien extrahieren ",
        "export_desc": (
            "Wählen Sie .rpy-Dateien/Ordner aus oder ziehen Sie sie hierher:"
        ),
        ...
        "lbl_excel_step": (
            "1. Übersetzte Excel-Datei auswählen oder hierher ziehen:"
        ),
        ...
        "sync_frame": " Alte RPY -> Neue RPY Synchronisieren ",
        "lbl_old_rpy_step": "1. Alte übersetzte .rpy-Dateien auswählen:",
        "lbl_new_rpy_step": "2. Neue unübersetzte .rpy-Dateien auswählen:",
        "btn_start_sync": " SYNCHRONISATION STARTEN ",
        "excel_notes_sheet": (
            "Tragen Sie Übersetzungen in die Spalte 'Übersetzung' ein."
        ),
        ...
        "msg_warn_rpy_folder": (
            "Bitte wählen Sie mindestens eine Datei oder einen Ordner aus!"
        ),
        "msg_success_merge": (
            "Erfolgreich in {} .rpy-Datei(en) zusammengeführt!"
        ),
        "msg_err_merge": "Fehler beim Zusammenführen:\n{}",
        "msg_warn_sync_old": "Bitte wählen Sie alte übersetzte Dateien aus!",
        "msg_warn_sync_new": "Bitte wählen Sie neue Dateien aus!",
        "msg_success_sync": (
            "Erfolgreich synchronisiert!\n- Aktualisierte Dateien: {}\n-"
            " Übereinstimmende Zeilen: {}"
        ),
        "msg_err_sync": "Fehler beim Synchronisieren:\n{}",
    ...
    "Français": {
        ...
        "tab_sync": " 3. Synchroniser RPY ",
        "export_frame": " Extraire les fichiers de traduction ",
        "export_desc": (
            "Sélectionnez ou glissez-déposez les fichiers/dossiers .rpy :"
        ),
        ...
        "lbl_excel_step": (
            "1. Sélectionner ou glisser le fichier Excel traduit :"
        ),
        "btn_browse_excel": "Parcourir Excel...",
        "lbl_rpy_step": (
            "2. Sélectionner ou glisser les fichiers .rpy ou le dossier :"
        ),
        "btn_start_merge": " LANCER LA FUSION ",
        "sync_frame": " Synchroniser Ancien RPY -> Nouveau RPY ",
        "lbl_old_rpy_step": "1. Sélectionner les ANCIENS fichiers .rpy traduits :",
        "lbl_new_rpy_step": (
            "2. Sélectionner les NOUVEAUX fichiers .rpy non traduits :"
        ),
        "btn_start_sync": " LANCER LA SYNCHRONISATION ",
        "excel_notes_sheet": "Traduisez dans la colonne 'Traduction'.",
        "msg_warn_select_rpy": (
            "Veuillez sélectionner au moins un fichier .rpy !"
        ),
        ...
        "msg_warn_rpy_folder": (
            "Veuillez sélectionner au moins un fichier ou un dossier !"
        ),
        "msg_success_merge": "Fusion réussie dans {} fichier(s) .rpy !",
        "msg_err_merge": "Erreur lors de la fusion :\n{}",
        "msg_warn_sync_old": "Sélectionnez au moins un ancien fichier RPY !",
        "msg_warn_sync_new": "Sélectionnez au moins un nouveau fichier RPY !",
        "msg_success_sync": (
            "Synchronisation réussie !\n- Fichiers mis à jour : {}\n- Lignes"
            " correspondantes : {}"
        ),
        "msg_err_sync": "Erreur lors de la synchronisation :\n{}",
    ...
    "Bahasa Indonesia": {
        ...
        "tab_sync": " 3. Sinkronkan RPY ",
        "export_frame": " Ekstrak Berkas Terjemahan ",
        "export_desc": (
            "Pilih atau TARIK berkas/folder .rpy ke daftar di bawah:"
        ),
        ...
        "sync_frame": " Sinkronkan RPY Lama -> RPY Baru ",
        "lbl_old_rpy_step": "1. Pilih berkas .rpy LAMA yang sudah diterjemahkan:",
        "lbl_new_rpy_step": "2. Pilih berkas .rpy BARU yang belum diterjemahkan:",
        "btn_start_sync": " MULAI SINKRONISASI ",
        ...
        "msg_warn_sync_old": "Pilih setidaknya satu berkas RPY lama!",
        "msg_warn_sync_new": "Pilih setidaknya satu berkas RPY baru!",
        "msg_success_sync": (
            "Berhasil disinkronkan!\n- Berkas diperbarui: {}\n- Kalimat cocok:"
            " {}"
        ),
        "msg_err_sync": "Galat saat menyinkronkan:\n{}",
    ...
    "العربية": {
        ...
        "sync_frame": " مزامنة RPY القديم -> RPY الجديد ",
        "lbl_old_rpy_step": "1. حدد ملفات RPY القديمة المترجمة:",
        "lbl_new_rpy_step": "2. حدد ملفات RPY الجديدة غير المترجمة:",
        "btn_start_sync": " بدء المزامنة ",
        ...
        "msg_warn_sync_old": "يرجى تحديد ملف RPY قديم واحد على الأقل!",
        "msg_warn_sync_new": "يرجى تحديد ملف RPY جديد واحد على الأقل!",
        "msg_success_sync": (
            "تمت المزامنة بنجاح!\n- الملفات المحدثة: {}\n- الجمل المتطابقة: {}"
        ),
        "msg_err_sync": "حدث خطأ أثناء المزامنة:\n{}",
    ...
    "Türkçe": {
        ...
        "tab_sync": " 3. RPY Senkronize Et ",
        "export_frame": " Çeviri Dosyalarını Ayıkla ",
        "export_desc": (
            ".rpy dosyalarını/klasörlerini seçin veya buraya sürükleyin:"
        ),
        ...
        "sync_frame": " Eski RPY -> Yeni RPY Senkronize Et ",
        "lbl_old_rpy_step": "1. Çevrilmiş ESKİ .rpy dosyalarını seçin:",
        "lbl_new_rpy_step": "2. Çevrilmemiş YENİ .rpy dosyalarını seçin:",
        "btn_start_sync": " SENKRONİZASYONU BAŞLAT ",
        ...
        "msg_warn_rpy_folder": (
            "Lütfen en az bir dosyası veya klasör seçin!"
        ),
        "msg_success_merge": (
            "Çeviriler {} .rpy dosyasına başarıyla birleştirildi!"
        ),
        "msg_err_merge": "Birleştirilirken hata oluştu:\n{}",
        "msg_warn_sync_old": "Lütfen en az bir eski RPY dosyası seçin!",
        "msg_warn_sync_new": "Lütfen en az bir yeni RPY dosyası seçin!",
        "msg_success_sync": (
            "Başarıyla senkronize edildi!\n- Güncellenen dosyalar: {}\n-"
            " Eşleşen satırlar: {}"
        ),
        "msg_err_sync": "Senkronize edilirken hata oluştu:\n{}",
    ...
    "Português": {
        ...
        "export_desc": (
            "Selecione ou ARRASTE arquivos/pastas .rpy para a lista:"
        ),
        ...
        "sync_frame": " Sincronizar RPY Antigo -> RPY Novo ",
        "lbl_old_rpy_step": "1. Selecione arquivos .rpy ANTIGOS traduzidos:",
        "lbl_new_rpy_step": "2. Selecione arquivos .rpy NOVOS não traduzidos:",
        "btn_start_sync": " INICIAR SINCRONIZAÇÃO ",
        ...
        "msg_success_merge": (
            "Traduções mescladas com sucesso em {} arquivo(s) .rpy!"
        ),
        "msg_err_merge": "Erro ao mesclar:\n{}",
        "msg_warn_sync_old": "Selecione pelo menos um arquivo RPY antigo!",
        "msg_warn_sync_new": "Selecione pelo menos um arquivo RPY novo!",
        "msg_success_sync": (
            "Sincronizado com sucesso!\n- Arquivos atualizados: {}\n- Frases"
            " correspondentes: {}"
        ),
        "msg_err_sync": "Erro ao sincronizar:\n{}",
    ...
    "Polski": {
        ...
        "lbl_excel_step": (
            "1. Wybierz lub PRZECIĄGNIJ przetłumaczony plik Excel:"
        ),
        "btn_browse_excel": "Przeglądaj Excel...",
        "lbl_rpy_step": (
            "2. Wybierz lub PRZECIĄGNIJ docelowe pliki .rpy lub folder:"
        ),
        "btn_start_merge": " ROZPOCZNIJ SCALANIE ",
        "sync_frame": " Synchronizuj Stary RPY -> Nowy RPY ",
        "lbl_old_rpy_step": "1. Wybierz STARE przetłumaczone pliki .rpy:",
        "lbl_new_rpy_step": "2. Wybierz NOWE nieprzetłumaczone pliki .rpy:",
        "btn_start_sync": " ROZPOCZNIJ SYNCHRONIZACJĘ ",
        ...
        "msg_success_merge": (
            "Pomyślnie scalono tłumaczenia w {} plikach .rpy!"
        ),
        "msg_err_merge": "Błąd podczas scalania:\n{}",
        "msg_warn_sync_old": "Wybierz co najmniej jeden stary plik RPY!",
        "msg_warn_sync_new": "Wybierz co najmniej jeden nowy plik RPY!",
        "msg_success_sync": (
            "Pomyślnie zsynchronizowano!\n- Zaktualizowane pliki: {}\n- Dopasowane"
            " zdania: {}"
        ),
        "msg_err_sync": "Błąd podczas synchronizacji:\n{}",
    ...
    "Русский": {
        ...
        "sync_frame": " Синхронизация старых и новых файлов RPY ",
        "lbl_old_rpy_step": (
            "1. Выберите переведенные СТАРЫЕ файлы/папки .rpy:"
        ),
        "lbl_new_rpy_step": (
            "2. Выберите непереведенные НОВЫЕ файлы/папки .rpy:"
        ),
        "btn_start_sync": " НАЧАТЬ СИНХРОНИЗАЦИЮ ",
        ...
        "msg_success_merge": (
            "Успешно объединены переводы в {} файл(ах) .rpy!"
        ),
        "msg_err_merge": "Ошибка при объединении:\n{}",
        "msg_warn_sync_old": "Выберите хотя бы один старый файл RPY!",
        "msg_warn_sync_new": "Выберите хотя бы один новый файл RPY!",
        "msg_success_sync": (
            "Успешно синхронизировано!\n- Обновлено файлов: {}\n- Совпадений"
            " строк: {}"
        ),
        "msg_err_sync": "Ошибка при синхронизации:\n{}",
    ...
    "Українська": {
        ...
        "sync_frame": " Синхронізація Старих і Нових RPY ",
        "lbl_old_rpy_step": "1. Виберіть СТАРІ перекладені файли .rpy:",
        "lbl_new_rpy_step": "2. Виберіть НОВІ неперекладені файли .rpy:",
        "btn_start_sync": " ПОЧАТИ СИНХРОНІЗАЦІЮ ",
        ...
        "msg_success_merge": (
            "Успішно об'єднано переклади в {} файл(ах) .rpy!"
        ),
        "msg_err_merge": "Помилка під час злиття:\n{}",
        "msg_warn_sync_old": "Виберіть принаймні один старий файл RPY!",
        "msg_warn_sync_new": "Виберіть принаймні один новий файл RPY!",
        "msg_success_sync": (
            "Успішно синхронізовано!\n- Оновлено файлів: {}\n- Збігів рядків:"
            " {}"
        ),
        "msg_err_sync": "Помилка під час синхронізації:\n{}",
    ...
    "日本語": {
        ...
        "export_desc": (
            ".rpy ファイル/フォルダを選択またはドラッグ＆ドロップしてください:"
        ),
        ...
        "sync_frame": " 新旧 RPY ファイルの同期 ",
        "lbl_old_rpy_step": "1. 翻訳済みの【旧 .rpy】ファイルを選択:",
        "lbl_new_rpy_step": "2. 未翻訳の【新 .rpy】ファイルを選択:",
        "btn_start_sync": " 同期を開始 ",
        "excel_notes_sheet": "'翻訳' 列に翻訳を入力してください。",
        "msg_warn_select_rpy": (
            "少なくとも1つの .rpy ファイルを選択してください！"
        ),
        ...
        "msg_success_merge": (
            "{} 個の .rpy ファイルに翻訳を正常に統合しました！"
        ),
        "msg_err_merge": "統合中にエラーが発生しました:\n{}",
        "msg_warn_sync_old": "旧 RPY ファイルを選択してください！",
        "msg_warn_sync_new": "新 RPY ファイルを選択してください！",
        "msg_success_sync": (
            "正常に同期されました！\n- 更新されたファイル数: {}\n- 一致した対話数:"
            " {}"
        ),
        "msg_err_sync": "同期中にエラーが発生しました:\n{}",
    ...
    "한국어": {
        ...
        "lbl_excel_step": (
            "1. 번역된 Excel 파일을 선택하거나 끌어다 놓으세요:"
        ),
        "btn_browse_excel": "Excel 찾아보기...",
        "lbl_rpy_step": "2. 대상 .rpy 파일 또는 폴더를 선택/끌어다 놓으세요:",
        "btn_start_merge": " 번역 병합 시작 ",
        "sync_frame": " 구버전 RPY -> 신버전 RPY 동기화 ",
        "lbl_old_rpy_step": "1. 번역된 [구버전 .rpy] 파일 선택:",
        "lbl_new_rpy_step": "2. 미번역된 [신버전 .rpy] 파일 선택:",
        ...
        "msg_success_merge": (
            "{}개의 .rpy 파일에 번역을 성공적으로 병합했습니다!"
        ),
        "msg_err_merge": "병합 중 오류 발생:\n{}",
        "msg_warn_sync_old": "구버전 RPY 파일을 선택하세요!",
        "msg_warn_sync_new": "신버전 RPY 파일을 선택하세요!",
        "msg_success_sync": (
            "성공적으로 동기화되었습니다!\n- 업데이트된 파일: {}\n- 일치하는"
            " 대사: {}"
        ),
        "msg_err_sync": "동기화 중 오류 발생:\n{}",
    ...
    "Italiano": {
        ...
        "sync_frame": " Sincronizza Vecchio RPY -> Nuovo RPY ",
        "lbl_old_rpy_step": "1. Seleziona i VECCHI file .rpy tradotti:",
        "lbl_new_rpy_step": "2. Seleziona i NUOVI file .rpy non tradotti:",
        "btn_start_sync": " AVVIA SINCRONIZZAZIONE ",
        ...
        "msg_success_merge": (
            "Traduzioni unite con successo in {} file .rpy!"
        ),
        "msg_err_merge": "Errore durante l'unione:\n{}",
        "msg_warn_sync_old": "Seleziona almeno un vecchio file RPY!",
        "msg_warn_sync_new": "Seleziona almeno un nuovo file RPY!",
        "msg_success_sync": (
            "Sincronizzazione riuscita!\n- File aggiornati: {}\n- Frasi"
            " corrispondenti: {}"
        ),
        "msg_err_sync": "Errore durante la sincronizzazione:\n{}",
...
class RPYtoEXCELApp:
  ...
  def __init__(self, root):
    ...
    self.lbl_lang_select = ttk.Label(
        lang_frame, text="Language:", font=("Segoe UI", 9, "bold")
    )
    ...
    self.notebook.add(self.tab_sync, text="")
    self.setup_sync_tab()
  ...
  def t(self, key):
    lang_dict = TRANSLATIONS.get(
        self.current_lang, TRANSLATIONS.get("English", {})
    )
  ...
  def update_ui_text(self):
    ...
    self.notebook.tab(self.tab_sync, text=self.t("tab_sync"))
    ...
    self.sync_lf.config(text=self.t("sync_frame"))
    self.lbl_old_rpy_step.config(text=self.t("lbl_old_rpy_step"))
    self.btn_sync_old_files.config(text=self.t("btn_add_files"))
    self.btn_sync_old_folder.config(text=self.t("btn_add_folder"))
    self.btn_sync_old_clear.config(text=self.t("btn_clear_list"))

    self.lbl_new_rpy_step.config(text=self.t("lbl_new_rpy_step"))
    self.btn_sync_new_files.config(text=self.t("btn_add_files"))
    self.btn_sync_new_folder.config(text=self.t("btn_add_folder"))
    self.btn_sync_new_clear.config(text=self.t("btn_clear_list"))
    self.btn_sync.config(text=self.t("btn_start_sync"))
  ...
  def setup_export_tab(self):
    ...
    self.lbl_export_desc = ttk.Label(
        self.export_lf, text="", font=("Segoe UI", 10)
    )
    ...
    scrollbar = ttk.Scrollbar(
        list_frame, orient="vertical", command=self.export_listbox.yview
    )
    ...
    self.btn_add_folder = ttk.Button(
        btn_box, text="", command=self.add_rpy_folder
    )
    self.btn_add_folder.pack(side="left", padx=5)

    self.btn_clear = ttk.Button(
        btn_box, text="", command=lambda: self.export_listbox.delete(0, tk.END)
    )
    ...
    self.btn_export = ttk.Button(
        out_frame, text="", command=self.process_export
    )
    ...
    try:
      with pd.ExcelWriter(save_path, engine="openpyxl") as writer:
          ...
          for idx, line in enumerate(lines, start=1):
            ...
            if line_strip.startswith("#") and '"' in line_strip:
              ...
              if start_pos != end_pos:
                ...
                if english_text.startswith("game/") or english_text.endswith(
                    ".rpy"
                ):
                  continue
                ...
                for offset in range(1, 4):
                  ...
                  if next_line_strip.startswith(
                      "#"
                  ) or next_line_strip.startswith("translate"):
                    break
        ...
        green_fill = PatternFill(
            start_color="356854", end_color="356854", fill_type="solid"
        )
        gray_fill = PatternFill(
            start_color="F6F8F9", end_color="F6F8F9", fill_type="solid"
        )
          ...
          for col in ws.columns:
            ...
            if col_letter in fixed_widths:
              ...
              for cell in col:
                ...
                val_len = (
                    len(val_str) + 6 if cell.row == 1 else len(val_str)
                )
                if val_len > max_len:
                  max_len = val_len
        ...
        start_row = 4
        progress_table_mapping = [
            item for item in table_mapping if item[0] != addition_sheet_title
        ]

        for idx, (sheet_name, table_name) in enumerate(
            progress_table_mapping, start=start_row
        ):
          cell_file = ws_notes.cell(row=idx, column=3, value=sheet_name)
          cell_file.alignment = Alignment(
          ...
          cell_prog.value = (
              f"=COUNTA({table_name}[{col_trans_name}])/COUNTA({table_name}[{col_orig_name}])"
          )
          cell_prog.number_format = "0.00%"
          cell_prog.alignment = Alignment(
              horizontal="center", vertical="center"
          )

        sum_row = start_row + len(progress_table_mapping)
        cell_sum_lbl = ws_notes.cell(
            row=sum_row, column=3, value=self.t("sum_title")
        )
        cell_sum_lbl.font = Font(bold=True)
        cell_sum_lbl.alignment = Alignment(
            horizontal="center", vertical="center"
        )

        if progress_table_mapping:
          trans_parts = [
              f"COUNTA({tname}[{col_trans_name}])"
              for _, tname in progress_table_mapping
          ]
          orig_parts = [
              f"COUNTA({tname}[{col_orig_name}])"
              for _, tname in progress_table_mapping
          ]
          sum_formula = (
              f"=({' + '.join(trans_parts)})/({' + '.join(orig_parts)})"
          )
        ...
        ws_notes.column_dimensions["D"].width = max(
            len(self.t("progress_title")) + 8, 18
        )

      messagebox.showinfo(
          self.t("success"), self.t("msg_success_export").format(save_path)
      )

    except Exception as e:
      messagebox.showerror(
          self.t("error"), self.t("msg_err_export").format(str(e))
      )
  ...
  def setup_merge_tab(self):
    ...
    self.lbl_excel_step = ttk.Label(
        self.merge_lf, text="", font=("Segoe UI", 10, "bold")
    )
    ...
    self.btn_browse_excel = ttk.Button(
        excel_box, text="", command=self.browse_excel_file
    )
    ...
    self.btn_merge_add_files = ttk.Button(
        btn_box, text="", command=self.add_merge_rpy_files
    )
    self.btn_merge_add_files.pack(side="left", padx=5)

    self.btn_merge_add_folder = ttk.Button(
        btn_box, text="", command=self.add_merge_rpy_folder
    )
    self.btn_merge_add_folder.pack(side="left", padx=5)

    self.btn_merge_clear = ttk.Button(
        btn_box, text="", command=lambda: self.merge_listbox.delete(0, tk.END)
    )
    self.btn_merge_clear.pack(side="left", padx=5)

    self.btn_merge = ttk.Button(
        self.merge_lf, text="", command=self.process_merge
    )
  ...
  def process_merge(self):
    ...
    possible_addition_sheets = {
        trans.get("sheet_addition_name", "").strip()
        for trans in TRANSLATIONS.values()
    }
    possible_addition_sheets.update({
        "Addition",
        "Bổ sung",
        "Adicional",
        "补充",
    ...
    try:
      ...
      for sheet_name, df in excel_sheets.items():
        ...
        file_col = next(
            (c for c in df.columns if c in possible_file_cols), df.columns[0]
        )
        label_col = next(
            (c for c in df.columns if c in possible_label_cols),
            df.columns[3] if len(df.columns) > 3 else None,
        )
        orig_col = next(
            (c for c in df.columns if c in possible_original_cols),
            df.columns[5] if len(df.columns) > 5 else None,
        )
        trans_col = next(
            (c for c in df.columns if c in possible_translated_cols),
        ...
        for _, row in df.iterrows():
          ...
          if not file_name or file_name == "nan":
            if not is_addition_sheet:
              file_name = (
                  f"{sheet_name}.rpy"
                  if not sheet_name.endswith(".rpy")
                  else sheet_name
              )
            else:
              continue
          ...
          if is_addition_sheet:
            ...
            if label_val == "strings" or not label_val:
              ...
              if (
                  label_key in dialogue_label_trans
                  and dialogue_label_trans[label_key] != translated_text
              ):
                ambiguous_labels.add(label_key)
              else:
                dialogue_label_trans[label_key] = translated_text
              dialogue_trans[(file_name, label_val, original_text)] = (
                  translated_text
              )
            ...
            if first_q != last_q:
              ...
              if trans_text:
                for offset in range(1, 4):
                  ...
                  if target_strip.startswith("#") or target_strip.startswith(
                      "translate"
                  ):
                    break
                  if '"' in target_strip:
              ...
              if not trans_text:
                for (fname, otext), ttext in string_trans.items():
                  if otext == orig_text:
                    ...
                    break
              if trans_text:
                if i + 1 < len(new_lines) and new_lines[i + 1].strip().startswith(
                    "new"
                ):
      ...
      messagebox.showinfo(
          self.t("success"), self.t("msg_success_merge").format(updated_count)
      )

    except Exception as e:
      messagebox.showerror(
          self.t("error"), self.t("msg_err_merge").format(str(e))
      )

  def setup_sync_tab(self):
    self.sync_lf = ttk.LabelFrame(self.tab_sync, text="")
    self.sync_lf.pack(fill="both", expand=True, padx=15, pady=15)

    self.lbl_old_rpy_step = ttk.Label(
        self.sync_lf, text="", font=("Segoe UI", 9, "bold")
    )
    self.lbl_old_rpy_step.pack(anchor="w", padx=10, pady=(5, 2))

    old_list_frame = ttk.Frame(self.sync_lf)
    old_list_frame.pack(fill="both", expand=True, padx=10, pady=2)

    self.sync_old_listbox = tk.Listbox(
        old_list_frame, selectmode=tk.EXTENDED, height=5
    )
    self.sync_old_listbox.pack(side="left", fill="both", expand=True)

    sc_old = ttk.Scrollbar(
        old_list_frame, orient="vertical", command=self.sync_old_listbox.yview
    )
    sc_old.pack(side="right", fill="y")
    self.sync_old_listbox.config(yscrollcommand=sc_old.set)

    if HAS_DND:
      self.sync_old_listbox.drop_target_register(DND_FILES)
      self.sync_old_listbox.dnd_bind(
          "<<Drop>>",
          lambda e: self.drop_sync_files(e, self.sync_old_listbox),
      )

    btn_box_old = ttk.Frame(self.sync_lf)
    btn_box_old.pack(fill="x", padx=10, pady=2)

    self.btn_sync_old_files = ttk.Button(
        btn_box_old,
        text="",
        command=lambda: self.add_sync_rpy_files(self.sync_old_listbox),
    )
    self.btn_sync_old_files.pack(side="left", padx=5)

    self.btn_sync_old_folder = ttk.Button(
        btn_box_old,
        text="",
        command=lambda: self.add_sync_rpy_folder(self.sync_old_listbox),
    )
    self.btn_sync_old_folder.pack(side="left", padx=5)

    self.btn_sync_old_clear = ttk.Button(
        btn_box_old,
        text="",
        command=lambda: self.sync_old_listbox.delete(0, tk.END),
    )
    self.btn_sync_old_clear.pack(side="left", padx=5)

    self.lbl_new_rpy_step = ttk.Label(
        self.sync_lf, text="", font=("Segoe UI", 9, "bold")
    )
    self.lbl_new_rpy_step.pack(anchor="w", padx=10, pady=(10, 2))

    new_list_frame = ttk.Frame(self.sync_lf)
    new_list_frame.pack(fill="both", expand=True, padx=10, pady=2)

    self.sync_new_listbox = tk.Listbox(
        new_list_frame, selectmode=tk.EXTENDED, height=5
    )
    self.sync_new_listbox.pack(side="left", fill="both", expand=True)

    sc_new = ttk.Scrollbar(
        new_list_frame, orient="vertical", command=self.sync_new_listbox.yview
    )
    sc_new.pack(side="right", fill="y")
    self.sync_new_listbox.config(yscrollcommand=sc_new.set)

    if HAS_DND:
      self.sync_new_listbox.drop_target_register(DND_FILES)
      self.sync_new_listbox.dnd_bind(
          "<<Drop>>",
          lambda e: self.drop_sync_files(e, self.sync_new_listbox),
      )

    btn_box_new = ttk.Frame(self.sync_lf)
    btn_box_new.pack(fill="x", padx=10, pady=2)

    self.btn_sync_new_files = ttk.Button(
        btn_box_new,
        text="",
        command=lambda: self.add_sync_rpy_files(self.sync_new_listbox),
    )
    self.btn_sync_new_files.pack(side="left", padx=5)

    self.btn_sync_new_folder = ttk.Button(
        btn_box_new,
        text="",
        command=lambda: self.add_sync_rpy_folder(self.sync_new_listbox),
    )
    self.btn_sync_new_folder.pack(side="left", padx=5)

    self.btn_sync_new_clear = ttk.Button(
        btn_box_new,
        text="",
        command=lambda: self.sync_new_listbox.delete(0, tk.END),
    )
    self.btn_sync_new_clear.pack(side="left", padx=5)

    self.btn_sync = ttk.Button(
        self.sync_lf, text="", command=self.process_sync
    )
    self.btn_sync.pack(fill="x", padx=10, pady=10, ipady=5)

  def drop_sync_files(self, event, target_listbox):
    files = self.root.tk.splitlist(event.data)
    for path in files:
      path = path.strip("{}")
      if os.path.isfile(path) and path.endswith(".rpy"):
        if path not in target_listbox.get(0, tk.END):
          target_listbox.insert(tk.END, path)
      elif os.path.isdir(path):
        rpy_files = glob.glob(os.path.join(path, "**", "*.rpy"), recursive=True)
        for f in rpy_files:
          if f not in target_listbox.get(0, tk.END):
            target_listbox.insert(tk.END, f)

  def add_sync_rpy_files(self, target_listbox):
    files = filedialog.askopenfilenames(
        title=self.t("dlg_select_rpy"),
        filetypes=[("Ren'Py Script", "*.rpy"), ("All Files", "*.*")],
    )
  ...
  def add_sync_rpy_folder(self, target_listbox):
    d = filedialog.askdirectory(title=self.t("dlg_select_folder"))
    if d:
      rpy_files = glob.glob(os.path.join(d, "**", "*.rpy"), recursive=True)
      for f in rpy_files:
  ...
  def process_sync(self):
    old_rpy_files = list(self.sync_old_listbox.get(0, tk.END))
    new_rpy_files = list(self.sync_new_listbox.get(0, tk.END))

    if not old_rpy_files:
      messagebox.showwarning(self.t("warning"), self.t("msg_warn_sync_old"))
      return

    if not new_rpy_files:
      messagebox.showwarning(self.t("warning"), self.t("msg_warn_sync_new"))
      return
    ...
    try:
          ...
          if line_strip.startswith("translate ") and line_strip.endswith(":"):
            ...
            for offset in range(1, 4):
              ...
              if '"' in target_line:
                ...
                t_end = target_line.rfind('"')
                if t_start != t_end:
                  trans_text = target_line[t_start + 1 : t_end]
                  if trans_text.strip():
                    dialogue_label_db[(file_name, current_label)] = trans_text
                    dialogue_label_db[current_label] = trans_text
                  break
            ...
            if first_q != last_q:
              ...
              if i + 1 < len(lines) and lines[i + 1].strip().startswith("new"):
                ...
                t_end = next_line.rfind('"')
                if t_start != t_end:
                  trans_text = next_line[t_start + 1 : t_end]
                  if trans_text.strip():
                    strings_db[orig_text] = trans_text
                    strings_file_db[(file_name, orig_text)] = trans_text
          i += 1

      updated_files_count = 0
      matched_dialogue_count = 0

      for new_file in new_rpy_files:
        ...
        while i < len(new_lines):
          ...
          if line_strip.startswith("translate ") and line_strip.endswith(":"):
            ...
            if first_q != last_q:
              ...
              trans_text = dialogue_label_db.get((file_name, current_label))
              if not trans_text:
                trans_text = dialogue_label_db.get(current_label)
            ...
            if first_q != last_q:
              ...
              trans_text = strings_file_db.get((file_name, orig_text))
              if not trans_text:
                trans_text = strings_db.get(orig_text)
      ...
      messagebox.showinfo(
          self.t("success"),
          self.t("msg_success_sync").format(
              updated_files_count, matched_dialogue_count
          ),
      )

    except Exception as e:
      messagebox.showerror(
          self.t("error"), self.t("msg_err_sync").format(str(e))
      )
